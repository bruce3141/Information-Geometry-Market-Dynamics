...
I thank the institutional-investor contact who raised applications of the SDHO phase-space framework to regime-conditional portfolio construction, whose questions sharpened the two-population reading of §4.2. I am also grateful to the quantitative-finance community on X for ongoing discussions of the SDHO phase-space framework and its cross-market tests; several threads there surfaced candidate markets that were ultimately tested in §6.2. The broader information-geometry, contact-geometry, and stochastic-thermodynamics communities whose work this paper builds on are cited throughout. Any errors are my own.
